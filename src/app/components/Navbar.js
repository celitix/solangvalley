...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { name: 'Nearby Places', path: '/scenic-view' },
    { name: 'Scenic View', path: '/nearby-places' },
    { name: 'Blog', path: '/blog' }
  ];
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 max-w-6xl mx-auto p-4">
      ...
      <div className=" bg-white rounded-full px-6 py-4 shadow-lg border border-2 border-black/20">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className="text-cyan-600 font-bold text-2xl hover:opacity-80 transition-opacity">
            Solang Valley
          </Link>
